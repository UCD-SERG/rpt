...
This package uses [altdoc](https://altdoc.etiennebacher.com/) with [docsify](https://docsify.js.org/) to build its documentation site. To build and preview the documentation locally:
