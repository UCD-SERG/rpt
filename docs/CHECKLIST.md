...
Remove example function from `R/example_function.R` (or keep as
reference)
...
**Tip**: Keep this checklist in your repository during development.
Delete it before your first release.
